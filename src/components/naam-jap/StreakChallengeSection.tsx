...
const StreakChallengeSection = () => {
    return (
        <section id="streak-challenge" className="w-full max-w-4xl mx-auto py-12 px-4">
            {/* Header */}
            ...
            <div className="space-y-8">
                ...
                <div className="bg-white rounded-2xl shadow-sm border border-orange-100 p-6 md:p-8">
                    ...
                    <ul className="space-y-3 font-medium text-gray-700">
                        ...
                        <li className="flex items-start gap-3">
                            <span className="text-orange-500 mt-1">•</span>
                            <span>Your streak starts automatically from your first valid day</span>
                        </li>
                        <li className="flex items-start gap-3">
                            <span className="text-orange-500 mt-1">•</span>
                ...
                <div className="bg-orange-50 rounded-2xl shadow-sm border border-orange-200 p-6 md:p-8">
                    ...
                    <ul className="space-y-3 font-medium text-gray-800">
                        <li className="flex items-start gap-3">
                            ...
                            <span>Minimum 108 japa required daily to count toward streak</span>
                        </li>
                        <li className="flex items-start gap-3">
                            <span className="text-red-500 mt-1">•</span>
                        ...
                        <li className="flex items-start gap-3">
                            <span className="text-red-500 mt-1">•</span>
                            <span>Tie-breakers: earlier streak start date, then random selection</span>
                        </li>
                    </ul>
                </div>
                    ...
                    <div className="space-y-3 font-medium text-gray-700">
                        <div className="flex flex-col sm:flex-row gap-4">
                            <div className="bg-gray-50 px-4 py-2 rounded-lg flex-1">
                                <span className="text-xs uppercase text-gray-500 block mb-1">Start Date</span>
                                <span className="font-bold text-gray-900">1st January 2026</span>
                            </div>
                            <div className="bg-gray-50 px-4 py-2 rounded-lg flex-1">
                                <span className="text-xs uppercase text-gray-500 block mb-1">End Date</span>
                                <span className="font-bold text-gray-900">31st December 2026</span>
                            </div>
                        </div>
                        <p className="text-sm text-gray-600 italic pt-2">
                            Monthly winners announced on the 1st of every month.<br />
                ...
                <div className="bg-yellow-50 rounded-xl p-6 text-center border border-yellow-100">
                    ...
                    <p className="text-yellow-900 text-sm leading-relaxed">
                        The true purpose of this challenge is spiritual discipline and devotion.
                        Prizes are a blessing, but the real reward is consistency in Radha Naam Jap.
                    </p>
                </div>
